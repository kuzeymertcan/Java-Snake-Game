...
public class GamePanel extends JPanel implements ActionListener {
    ...
    public void gameOver(Graphics g) {
        ...
        int x1 = (SCREEN_WIDTH - metrics1.stringWidth("Game Over")) / 2;
        ...
        int x2 = (SCREEN_WIDTH - metrics2.stringWidth("Score: " +applesEaten)) / 2;
        int y2 = g.getFont().getSize();
        g.drawString("Score: "+applesEaten, x2, y2);
